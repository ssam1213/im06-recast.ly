describe ('VideoPlayer', function() {
  ...
  it('should dynamically render a video', function() {
    ...
    var codeStatesVideoIFrameElement = findRenderedDOMComponentWithClass(codeStatesVideo, 'embed-responsive-item');
    ...
    expect(codeStatesVideoIFrameElement.src).to.equal('https://www.youtube.com/embed/000003');
  });
  ...
  it('should dynamically render a video\'s title', function() {
    ...
    var codeStatesVideoTitleElement = findRenderedDOMComponentWithClass(codeStatesVideo, 'video-player-details');
    ...
    expect(codeStatesVideoTitleElement.children[0].innerHTML).to.equal('Code States opens extension school on Mars');
  });
  ...
  it('should dynamically render a video\'s description', function() {
    ...
    var codeStatesVideoDescriptionElement = findRenderedDOMComponentWithClass(codeStatesVideo, 'video-player-details');
    ...
    expect(codeStatesVideoDescriptionElement.children[1].innerHTML).to.equal('Watch the ribbon cutting of the first coding bootcamp in space');
  });
});
